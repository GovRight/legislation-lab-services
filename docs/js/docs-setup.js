NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$scope $state angular api build change class commonly consider controller corpus corresponding create current custom data decorates default define depth discussion document enable example extracted extraction fields findbyid function govright grlocale grnodetree href instance label law length limit link locale locales localised logic loops maximum maxtitlelength method modifies module myapp nested ng-href ng-if ng-include ng-init ng-repeat node node-id nodehrefresolver nodeid nodes nodetitleresolver nodetree object original package parameters parent platformservices populated precessing property provided reference resolve resolver resolves return returns root search service settings site starts template text title tree true type type-hint type-hint-boolean type-hint-number type-hint-object type-hint-string url var version yielded"
    }
  ],
  "apis": {
    "api": true
